    ...
    def make_instance(self, include_optional) -> CoinsHistoricalData:
        ...
        if include_optional:
            return CoinsHistoricalData(
                ...
                image = coingecko_sdk.models.coins_historical_data_image.CoinsHistoricalData_image(
                    thumb = '', 
                    small = '', ),
                market_data = coingecko_sdk.models.coins_historical_data_market_data.CoinsHistoricalData_market_data(
                    ...
                    total_volume = coingecko_sdk.models.coins_historical_data_market_data_total_volume.CoinsHistoricalData_market_data_total_volume(
                        ...
                        eur = 1.337, 
                        usd = 1.337, ), ),
                community_data = coingecko_sdk.models.coins_historical_data_community_data.CoinsHistoricalData_community_data(
                ...
                developer_data = coingecko_sdk.models.coins_historical_data_developer_data.CoinsHistoricalData_developer_data(
                    forks = 1.337, 
                    stars = 1.337, 
                    subscribers = 1.337, 
                    total_issues = 1.337, 
                ...
                public_interest_stats = coingecko_sdk.models.coins_historical_data_public_interest_stats.CoinsHistoricalData_public_interest_stats(
                    alexa_rank = 1.337, 
                    bing_matches = 1.337, )
            )
        else:
