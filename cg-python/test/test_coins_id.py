...
class TestCoinsID(unittest.TestCase):
    """CoinsID unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CoinsID:
        """Test CoinsID
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CoinsID`
        """
        model = CoinsID()
        if include_optional:
            return CoinsID(
