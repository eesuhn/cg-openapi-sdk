...
class TestPoolInfo(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PoolInfo:
        ...
        if include_optional:
            return PoolInfo(
                data = [
                    coingecko_python.models.pool_info_data_inner.PoolInfo_data_inner(
                        id = '', 
                        type = '', 
                        attributes = coingecko_python.models.pool_info_data_inner_attributes.PoolInfo_data_inner_attributes(
