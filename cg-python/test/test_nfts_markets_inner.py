    ...
    def make_instance(self, include_optional) -> NFTsMarketsInner:
        ...
        if include_optional:
            return NFTsMarketsInner(
                ...
                floor_price_24h_percentage_change = coingecko_python.models.nfts_markets_inner_floor_price_24h_percentage_change.NFTsMarkets_inner_floor_price_24h_percentage_change(
                    usd = 1.337, 
                    native_currency = 1.337, ),
