    ...
    def make_instance(self, include_optional) -> CategoriesPools:
        ...
        if include_optional:
            return CategoriesPools(
                data = [
                    coingecko_sdk.models.categories_pools_data_inner.CategoriesPools_data_inner(
                        id = '', 
                        type = '', 
                ...
                included = [
                    coingecko_sdk.models.categories_pools_included_inner.CategoriesPools_included_inner(
                        id = '', 
                        type = '', 
