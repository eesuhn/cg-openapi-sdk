...
class DexesApi:
    ...
    def dexes_list(
        ...
        _param = self._dexes_list_serialize(
            network=network,
            page=page,
    ...
    @validate_call
    def dexes_list_without_preload_content(
        self,
        network: Annotated[StrictStr, Field(description="network ID <br> *refers to [/networks](/reference/networks-list)")],
        page: Annotated[Optional[StrictInt], Field(description="page through results <br> Default value: 1")] = None,
        _request_timeout: Union[
    ...
    def _dexes_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/onchain/networks/{network}/dexes',
