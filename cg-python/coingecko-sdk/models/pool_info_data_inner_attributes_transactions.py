...
class PoolInfoDataInnerAttributesTransactions(BaseModel):
    """
    ...
    h6: Optional[PoolDataInnerAttributesTransactionsM5] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "h6": PoolDataInnerAttributesTransactionsM5.from_dict(obj["h6"]) if obj.get("h6") is not None else None,
