...
class OHLCV(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": OHLCVData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "meta": OHLCVMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None
        })
        return _obj
