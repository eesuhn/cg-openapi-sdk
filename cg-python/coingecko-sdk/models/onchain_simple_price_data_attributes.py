...
class OnchainSimplePriceDataAttributes(BaseModel):
    """
    OnchainSimplePriceDataAttributes
    """ # noqa: E501
    token_prices: Optional[Dict[str, StrictStr]] = None
    __properties: ClassVar[List[str]] = ["token_prices"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "token_prices": obj.get("token_prices")
        })
        return _obj
