...
class CoinsDataBaseDeveloperData(BaseModel):
    """
    coin developer data
    """ # noqa: E501
    ...
    code_additions_deletions_4_weeks: Optional[CoinsDataBaseDeveloperDataCodeAdditionsDeletions4Weeks] = None
    commit_count_4_weeks: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="coin repository commit count in 4 weeks")
    last_4_weeks_commit_activity_series: Optional[List[Union[StrictFloat, StrictInt]]] = Field(default=None, description="coin repository last 4 weeks commit activity series")
    __properties: ClassVar[List[str]] = ["forks", "stars", "subscribers", "total_issues", "closed_issues", "pull_requests_merged", "pull_request_contributors", "code_additions_deletions_4_weeks", "commit_count_4_weeks", "last_4_weeks_commit_activity_series"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code_additions_deletions_4_weeks": CoinsDataBaseDeveloperDataCodeAdditionsDeletions4Weeks.from_dict(obj["code_additions_deletions_4_weeks"]) if obj.get("code_additions_deletions_4_weeks") is not None else None,
            "commit_count_4_weeks": obj.get("commit_count_4_weeks"),
            "last_4_weeks_commit_activity_series": obj.get("last_4_weeks_commit_activity_series")
        })
        return _obj
