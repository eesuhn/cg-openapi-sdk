...
class TrendingSearch(BaseModel):
    ...
    TrendingSearch
    """ # noqa: E501
    coins: Optional[List[TrendingSearchCoinsInner]] = None
    nfts: Optional[List[TrendingSearchNftsInner]] = None
    categories: Optional[List[TrendingSearchCategoriesInner]] = None
    __properties: ClassVar[List[str]] = ["coins", "nfts", "categories"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "coins": [TrendingSearchCoinsInner.from_dict(_item) for _item in obj["coins"]] if obj.get("coins") is not None else None,
            "nfts": [TrendingSearchNftsInner.from_dict(_item) for _item in obj["nfts"]] if obj.get("nfts") is not None else None,
            "categories": [TrendingSearchCategoriesInner.from_dict(_item) for _item in obj["categories"]] if obj.get("categories") is not None else None
        })
        return _obj
