...
class SearchCoinsInner(BaseModel):
    """
    SearchCoinsInner
    """ # noqa: E501
    ...
    api_symbol: Optional[StrictStr] = Field(default=None, description="coin api symbol")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "api_symbol", "symbol", "market_cap_rank", "thumb", "large"]
