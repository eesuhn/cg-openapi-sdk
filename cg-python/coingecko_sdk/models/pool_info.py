...
class PoolInfo(BaseModel):
    ...
    PoolInfo
    """ # noqa: E501
    data: Optional[List[PoolInfoDataInner]] = None
    included: Optional[List[PoolIncludedInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [PoolInfoDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "included": [PoolIncludedInner.from_dict(_item) for _item in obj["included"]] if obj.get("included") is not None else None
        })
        return _obj
