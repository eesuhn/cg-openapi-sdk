...
class CoinsTickersTickersInner(BaseModel):
    """
    ...
    market: Optional[CoinsTickersTickersInnerMarket] = None
    ...
    cost_to_move_up_usd: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="coin ticker cost to move up in usd")
    cost_to_move_down_usd: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="coin ticker cost to move down in usd")
    ...
    timestamp: Optional[StrictStr] = Field(default=None, description="coin ticker timestamp")
    last_traded_at: Optional[StrictStr] = Field(default=None, description="coin ticker last traded timestamp")
    last_fetch_at: Optional[StrictStr] = Field(default=None, description="coin ticker last fetch timestamp")
    ...
    __properties: ClassVar[List[str]] = ["base", "target", "market", "last", "volume", "cost_to_move_up_usd", "cost_to_move_down_usd", "converted_last", "converted_volume", "trust_score", "bid_ask_spread_percentage", "timestamp", "last_traded_at", "last_fetch_at", "is_anomaly", "is_stale", "trade_url", "token_info_url", "coin_id", "target_coin_id"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if token_info_url (nullable) is None
        # and model_fields_set contains the field
        if self.token_info_url is None and "token_info_url" in self.model_fields_set:
            _dict['token_info_url'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "market": CoinsTickersTickersInnerMarket.from_dict(obj["market"]) if obj.get("market") is not None else None,
            "last": obj.get("last"),
            "volume": obj.get("volume"),
            "cost_to_move_up_usd": obj.get("cost_to_move_up_usd"),
            "cost_to_move_down_usd": obj.get("cost_to_move_down_usd"),
