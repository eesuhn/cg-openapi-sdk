...
class CategoriesPoolsIncludedInnerAttributes(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["address", "name", "symbol", "decimals", "image_url", "coingecko_coin_id"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if coingecko_coin_id (nullable) is None
        # and model_fields_set contains the field
        if self.coingecko_coin_id is None and "coingecko_coin_id" in self.model_fields_set:
            _dict['coingecko_coin_id'] = None
