...
class NFTTickers(BaseModel):
    """
    NFTTickers
    """ # noqa: E501
    tickers: Optional[List[NFTTickersTickersInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tickers": [NFTTickersTickersInner.from_dict(_item) for _item in obj["tickers"]] if obj.get("tickers") is not None else None
        })
        return _obj
