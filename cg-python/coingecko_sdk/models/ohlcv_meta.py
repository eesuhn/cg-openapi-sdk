...
class OHLCVMeta(BaseModel):
    ...
    OHLCVMeta
    """ # noqa: E501
    base: Optional[OHLCVMetaBase] = None
    quote: Optional[OHLCVMetaBase] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "base": OHLCVMetaBase.from_dict(obj["base"]) if obj.get("base") is not None else None,
            "quote": OHLCVMetaBase.from_dict(obj["quote"]) if obj.get("quote") is not None else None
        })
        return _obj
