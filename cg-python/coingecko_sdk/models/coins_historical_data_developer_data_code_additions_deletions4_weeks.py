...
class CoinsHistoricalDataDeveloperDataCodeAdditionsDeletions4Weeks(BaseModel):
    """
    coin code additions deletions 4 weeks
    """ # noqa: E501
    additions: Optional[Union[StrictFloat, StrictInt]] = None
    deletions: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["additions", "deletions"]
