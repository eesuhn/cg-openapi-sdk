...
class CategoriesPools(BaseModel):
    """
    CategoriesPools
    """ # noqa: E501
    data: Optional[List[CategoriesPoolsDataInner]] = None
    included: Optional[List[CategoriesPoolsIncludedInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [CategoriesPoolsDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "included": [CategoriesPoolsIncludedInner.from_dict(_item) for _item in obj["included"]] if obj.get("included") is not None else None
        })
        return _obj
