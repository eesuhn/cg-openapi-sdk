...
class TokenLists(BaseModel):
    ...
    tokens: Optional[List[TokenListsTokensInner]] = None
    __properties: ClassVar[List[str]] = ["name", "logoURI", "keywords", "timestamp", "tokens"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tokens": [TokenListsTokensInner.from_dict(_item) for _item in obj["tokens"]] if obj.get("tokens") is not None else None
        })
        return _obj
