...
class CoinsListNewInner(BaseModel):
    """
    CoinsListNewInner
    """ # noqa: E501
    ...
    activated_at: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="timestamp when coin was activated on CoinGecko")
    __properties: ClassVar[List[str]] = ["id", "symbol", "name", "activated_at"]
