...
class DerivativesExchangesID(BaseModel):
    """
    ...
    tickers: Optional[List[DerivativesTickersList]] = None
    __properties: ClassVar[List[str]] = ["name", "open_interest_btc", "trade_volume_24h_btc", "number_of_perpetual_pairs", "number_of_futures_pairs", "image", "year_established", "country", "description", "url", "tickers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "url": obj.get("url"),
            "tickers": [DerivativesTickersList.from_dict(_item) for _item in obj["tickers"]] if obj.get("tickers") is not None else None
        })
        return _obj
