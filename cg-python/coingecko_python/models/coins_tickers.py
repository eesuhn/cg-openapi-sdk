...
class CoinsTickers(BaseModel):
    """
    CoinsTickers
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="coin name")
    tickers: Optional[List[CoinsTickersTickersInner]] = Field(default=None, description="list of tickers")
    __properties: ClassVar[List[str]] = ["name", "tickers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "tickers": [CoinsTickersTickersInner.from_dict(_item) for _item in obj["tickers"]] if obj.get("tickers") is not None else None
        })
        return _obj
