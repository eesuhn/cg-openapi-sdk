...
class CategoriesPoolsDataInner(BaseModel):
    """
    CategoriesPoolsDataInner
    """ # noqa: E501
    id: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    attributes: Optional[CategoriesPoolsDataInnerAttributes] = None
    relationships: Optional[CategoriesPoolsDataInnerRelationships] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": CategoriesPoolsDataInnerAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "relationships": CategoriesPoolsDataInnerRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None
        })
        return _obj
